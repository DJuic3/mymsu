...
const PASSWORD_AUTH_HINT = "Activation Code";
...
const IMAGE_LOGIN_PATH = "assets/grad.jpeg";
const IMAGE_WELCOME_PATH = "assets/msu.jpg";
const IMAGE_SLIPPER_PATH = "assets/cap.png";

const TEXT_SIGN_IN_LABEL = "SIGN IN";
const TEXT_MSU_LABEL = "MyMSU";
...
const BUTTON_ENTER = "FINISH";
const BUTTON_GOAHEAD = "SIGN IN";